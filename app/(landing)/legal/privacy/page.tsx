...
export default function PrivacyPage() {
  return (
    <>
      <title>Privacy Policy - Envisage 23</title>
      <div>
        <Title title="Privacy Policy" />
        <section className="prose mx-auto max-w-5xl px-5 py-20">
          <p>
            At Envisage, accessible from www.envisage.org.in, one of our main priorities
            is the privacy of our visitors. This Privacy Policy document contains types of
            information that is collected and recorded by Envisage and how we use it.
          </p>
          <p>
            If you have additional questions or require more information about our Privacy
            Policy, do not hesitate to contact us. Our Privacy Policy was created with the
            help of the{" "}
          ...
          <p>
            Envisage follows a standard procedure of using log files. These files log
          ...
          <p>
            Like any other website, Envisage uses &ldquo;cookies&rsquo;. These cookies are
          ...
          <p>
            ...
            advertising partners of Envisage.
          </p>

          <p>
            Third-party ad servers or ad networks uses technologies like cookies,
            JavaScript, or Web Beacons that are used in their respective advertisements
            and links that appear on Envisage, which are sent directly to users&apos;
          ...
          <p>
            Note that Envisage has no access to or control over these cookies that are
          ...
          <p>
            Envisage&apos;s Privacy Policy does not apply to other advertisers or
          ...
          <p>
            Envisage does not knowingly collect any Personal Identifiable Information from
          ...
          <p>
            ...
            and/or collect in Envisage. This policy is not applicable to any information
          ...
          <p>
            ...
            its <a href="/legal/terms">Terms and Conditions</a>.
          </p>
        </section>
      </div>
    </>
