    ...
    <>
      ...
      <div className="all overflow-x-hidden">
        ...
        <section className="mx-auto max-w-5xl px-4 py-20 sm:pt-10">
          <div className="mx-auto mb-10 flex flex-col bg-gray-900 items-center gap-y-4 rounded-3xl p-10 text-black transition-all duration-200 ease-in-out hover:scale-95 hover:shadow-2xl hover:ring-4 hover:ring-blue-500 hover:ring-offset-8 sm:flex-row">
          ...
          <div>
            ...
            <div className="grid grid-cols-3 gap-4">
              {events.map((event) => (
                <div
                  key={event.id}
                  className="cursor-pointer rounded-md border bg-white p-4 text-center text-lg font-semibold shadow transition-all duration-200 ease-in-out hover:bg-blue-500 hover:text-white hover:shadow-xl"
                >
                  {event.title}
                </div>
              ))}
          ...
          <div className="flex justify-center py-12">
            <button className="block rounded-lg bg-blue-600 px-6 py-4 text-center text-base font-semibold uppercase tracking-tight text-zinc-100 active:scale-95 sm:px-12 sm:text-xl">
